...
import Preloader from '../components/Preloader'; // imported for manual overlay
...
export default function Home() {
  ...
  return (
    <>
      {/* SYNCHRONOUS OVERLAY PRELOADER: Protects LCP while showing visual loading */}
              ...
              {featuredListings.map((listing) => (
                <SwiperSlide key={listing._id}>
                  ...
                  >
                    ...
                    {/* Performance Fix: Removed backdrop-blur-sm which was causing scroll lag, upgraded to 90% opacity alpha */}
